...
def get_audio_player(audio_buffer):
    """
    Create an audio player for Streamlit
    """
    if audio_buffer:
    ...
    for i, msg in enumerate(st.session_state.chat_history):
        if msg["role"] == "user":
            ...
            with st.chat_message("assistant"):
                ...
                # Add voice player for assistant messages
                ...
                if voice_enabled:
                    with st.spinner("Generating voice..."):
                        ...
                        if audio_buffer:
                            ...
                            # Auto-play using JavaScript (optional)
                            if auto_play:
                                st.markdown(
                                    """
                                    <script>
...
st.sidebar.info(
    ...
    "- Click the play button on audio players to hear responses"
)
